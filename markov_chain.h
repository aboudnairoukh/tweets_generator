...
/**
 * This function creates a new MarkovChain
 * @return a pointer to the new MarkovChain
 */
MarkovChain *new_markov_chain ();

/**
 * This function checks if the given word is an ending word (last char is '0')
 * @param word the given word
 * @return true is word is ending word
 */
bool is_ending_word (char *word);

/**
 * this function returns a pointer to the ind node in the given MarkovChain
 * @param ind
